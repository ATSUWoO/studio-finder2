    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-6">
          ...
          <div className="p-6">
            <div className="flex items-start justify-between gap-4 mb-4">
              <div>
                <span className="inline-block text-xs bg-gray-100 text-gray-500 rounded px-2 py-0.5 mb-2">
                  {venue.source_site}
                </span>
        ...
        <h2 className="text-lg font-bold text-gray-900 mb-3">
          スタジオ一覧
          <span className="ml-2 text-sm font-normal text-gray-500">{venue.rooms.length}部屋</span>
        </h2>
              ...
              <div className="flex items-start justify-between gap-4 mb-3">
                ...
                {room.price_per_hour !== null && (
                  <span className="text-indigo-600 font-bold text-lg shrink-0">
                    {formatPrice(room.price_per_hour)}<span className="text-sm font-normal text-gray-500">/時</span>
                  </span>
                )}
              </div>
              ...
              {room.facilities.length > 0 && (
                <div className="flex flex-wrap gap-1.5">
                  {room.facilities.map((f) => (
                    <span key={f} className="text-xs bg-indigo-50 text-indigo-600 rounded-full px-2.5 py-1">
                      {f}
                    </span>
                  ))}
                </div>
